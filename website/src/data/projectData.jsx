...
export const courses = [
  ...
  },
  {
    ...
    description: "Covers the data mining principles, algorithms, and applications. (come back) data preprocessing, data transformation, similarity and dissimilarity measures, data representation, classification techniques, association analysis, cluster analysis, and anomaly detection",
    tech: ["TopicA", "TopicB"],
    links: { details: "#" },
    skills: [ "Python", "Numpy", "also come back to this" ],
  },
  {
